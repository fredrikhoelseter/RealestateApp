package main.java.no.ntnu.idatx2001.realestateapp;
 ...
 * <ul>
 * <li>{@code init()} - Is responsible for initialising the app-object, by
 * creating the internal no.ntnu.iir.realestateapp.PropertyRegister-instance, and filling the phone book
 * with dummies (for debug)
 * </li>
 * <li>{@code start()} - Is the starting point of the application object.
 * After an instance of the no.ntnu.iir.realestateapp.RealestateApp-class have been created, this method
...
public class RealestateApp {
    ...
    // The no.ntnu.iir.realestateapp.Property register holding the properties
    ...
    /**
     * Creates an instance of the no.ntnu.iir.realestateapp.RealestateApp.
     */
    ...
    private int showMenu() {
        ...
        System.out.println("\n***** Register Application v" + VERSION + " *****\n");
     ...
     * create a new no.ntnu.iir.realestateapp.Property to be added to the register. If all data is
    ...
    public void addRealestatToRegister() {
        ...
        if (userInputValidSoFar) {
            ...
            System.out.println("no.ntnu.iir.realestateapp.Property " + property.getMunicipalityNumber()
    ...
    public void listAllRealestates() {
        if (0 == this.properties.getNumberOfProperties()) {
    ...
    private void findRealestatesByOwner() {
        ...
        System.out.println("Search for realestates by owner.");
        System.out.println("");
        
        System.out.println("Please enter name of owner to search for: ");
        ...
        if (owner.isBlank() || owner.isEmpty()) {
            ...
            System.out.println("Found properties:");
            System.out.println();
            propertiesFound = properties.findAllPropertiesByOwner(owner);
            while (propertiesFound.hasNext())
            {
                displayProperty(propertiesFound.next());
                System.out.println();
